...
import json
with open ("./01_DATA/Amidase_3/05_3_Region_Conservation_24567/fingerprints.json", "w") as file:
...
import json
with open("./01_DATA/Amidase_3/05_3_Region_Conservation_24567/fingerprints.json", "r") as file:
...
for option in options_list:
    ...
    if len(cluster) != 0:
        with open (f"./01_DATA/Amidase_3/05_3_Region_Conservation_24567/{option}", "w") as f:
            json.dump(cluster, f)
...
for file_name in os.listdir("./01_DATA/Amidase_3/05_3_Region_Conservation_24567/"):
    if file_name.startswith("["):
        with open(f"./01_DATA/Amidase_3/05_3_Region_Conservation_24567/{file_name}", "r") as file:
            fingerprints = json.load(file)
...
for i in range(len(length_dict)):
    plt.text(i + 0.05, list(length_dict.values())[i] + 250, list(length_dict.values())[i], ha="center", va="center", fontsize=6, rotation=90)
